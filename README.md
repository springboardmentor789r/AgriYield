 AgriYield Intelligent Crop Yield Prediction & Forecasting Platform
...
🚀 Features 🔍 1. Machine Learning-Based Yield Prediction
...
Frontend → Backend → Model → Forecast → Visualization All processes automated seamlessly using FastAPI + Axios.

🧪 Tech Stack Layer Technologies Backend FastAPI, Python, CatBoost, Prophet, Pandas, NumPy, Joblib, Uvicorn Frontend React.js, Tailwind CSS, Axios, Chart.js, React Router Dataset Kaggle — Crop Yield & Environmental Dataset (2014-2023) 📁 Dataset Highlights
