    ...
    <div className="max-w-4xl mx-auto py-12 px-6">
      <div className="bg-white p-8 rounded-xl shadow">
        ...
        <form onSubmit={submit} className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <InputField label="Nitrogen (N)" name="N" value={form.N} onChange={update} unit="ppm" />
          <InputField label="Phosphorus (P)" name="P" value={form.P} onChange={update} unit="ppm" />
          <InputField label="Potassium (K)" name="K" value={form.K} onChange={update} unit="ppm" />
